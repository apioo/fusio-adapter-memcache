...
namespace Fusio\Adapter\Memcache\Tests\Action;

use Fusio\Adapter\Memcache\Action\MemcacheResponse;
...
/**
 * MemcacheResponseTest
 *
 * @author  Christoph Kappestein <christoph.kappestein@gmail.com>
 * @license http://www.gnu.org/licenses/agpl-3.0
 * @link    http://fusio-project.org
 */
class MemcacheResponseTest extends MemcacheTestCase
{
    public function testHandle()
    {
        ...
        $action   = $this->getActionFactory()->factory(MemcacheResponse::class);
